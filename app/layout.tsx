...
export default async function RootLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <html lang="en" className={`${literata.variable} ${ballet.variable} ${GeistSans.variable}`}>
      <body className="relative bg-neutral-50 text-black selection:bg-teal-300 dark:bg-neutral-900 dark:text-white dark:selection:bg-theme-primary dark:selection:text-white">
